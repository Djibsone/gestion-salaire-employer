    ...
    <div class="box-container">
        ...
        <div class="transaction-box">
            ...
            <div class="item">
                ...
                <div class="value">{{ $fullPaymentInfo->employer->lastname }} & {{ $fullPaymentInfo->employer->firstname }} ({{ $fullPaymentInfo->employer->email }})</div>
            </div>
            <div class="item">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $fullPaymentInfo->amount }} F CFA</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <div class="single_item">
                                        ...
                                        <span class="value">{{ $fullPaymentInfo->amount }} F CFA</span>
                                    </div>
                                    <div class="single_item">
